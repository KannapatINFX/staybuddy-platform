...
| 3      | CONDITIONAL | Ordered review passes locally: 14-workspace pnpm/Turbo graph; enforced formatting, lint, dependency, fixture, OpenAPI drift, typecheck, tests, migration, artifact and secret gates; 24 unit and 6 integration cases; four required GitHub jobs; ADR/runbook/fixture/current-status structure            | Create/authorize the GitHub remote, push reviewed history, enable protected `main`, and record all four checks plus build artifact passing on a minimal-change pull request. |
